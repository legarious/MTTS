...
{   
    ...
    MongoClient.connect(url, function(err, db) 
    {
        ...
        dbo.collection('accounts').count({"Type":"Staff"})
...
function loop(){
    ...
    var data1 = {x:14.065330,y:100.609797};
    ...
    var data19 = {x:14.065278,y:100.598800};
